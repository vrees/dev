...
const int sleep_time = 10;  // Time to sleep (in seconds) between posts to Ubidots
WiFiClient client;
int anzahlVersucheTemp = 0;  
int anzahlVersucheHumity = 0;  
...
String variable_id1 = "5a3e203fc03f9735704824e1";
String variable_id2 = "5a3e20a4c03f9737f1b5c09d";
...
String token = "A1E-bBwUGC2aIx71cM04yl4DjZ2UcwdKIK";
...
String readTemperature(int*);
String readHumidity(int*);
...
void loop()
{
  ...
  String strTemp = readTemperature(&anzahlVersucheTemp);
  String strHum = readHumidity(&anzahlVersucheHumity);
  ...
  ubiSave_value(String(variable_id1), strTemp);
  ubiSave_value(String(variable_id2), strHum);

  // Send some debug messages over USB
  Serial.println("Ubidots data");
  Serial.println("temperature: " + strTemp + " - " + anzahlVersucheTemp);
  Serial.println("humidity: " + strHum + " - " + anzahlVersucheHumity);
...
String readTemperature(int* anzahlVersuche) {
...
String readHumidity(int* anzahlVersuche) {
