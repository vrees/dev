function surf2stl(filename,x,y,z,append,mode)
...
%
%   SURF2STL(...,append), where append is boolean (default 0), appends to
%   the current STL filename, allowing the construction of multiple
%   separate objects within a single file.
%
...
%   
%   Append added by Emmett Lalish, 03-15-2011
...
disp( sprintf('Total facets %d',nfacets) );
